...
public:
   ...
   */
    static void DecryptCompressed(const ipcl::CipherText& r_ct, const ipcl::PrivateKey&  a_sk, ConstLWECiphertext& ct,
...
void CompBinFHEContext::DecryptCompressed(const ipcl::CipherText& r_ct, const ipcl::PrivateKey&  a_sk, ConstLWECiphertext& ct,
                                LWEPlaintext* result, const LWEPlaintextModulus& p) {
