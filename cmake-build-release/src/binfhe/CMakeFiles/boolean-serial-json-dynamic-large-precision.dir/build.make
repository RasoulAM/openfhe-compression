...
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: lib/libOPENFHEbinfhe.so.1.0.1
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: lib/libOPENFHEcore.so.1.0.1
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: /home/r5akhava/diaa/pailliercryptolib/build/lib/libipcl.so.1.1.4
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: /usr/lib/x86_64-linux-gnu/libssl.so
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: /usr/lib/x86_64-linux-gnu/libcrypto.so
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: /usr/lib/gcc/x86_64-linux-gnu/11/libgomp.so
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: /usr/lib/x86_64-linux-gnu/libpthread.a
bin/examples/binfhe/boolean-serial-json-dynamic-large-precision: src/binfhe/CMakeFiles/boolean-serial-json-dynamic-large-precision.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/r5akhava/diaa/openfhe-development/cmake-build-release/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/examples/binfhe/boolean-serial-json-dynamic-large-precision"
	cd /home/r5akhava/diaa/openfhe-development/cmake-build-release/src/binfhe && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/boolean-serial-json-dynamic-large-precision.dir/link.txt --verbose=$(VERBOSE)
...
src/binfhe/CMakeFiles/boolean-serial-json-dynamic-large-precision.dir/clean:
	cd /home/r5akhava/diaa/openfhe-development/cmake-build-release/src/binfhe && $(CMAKE_COMMAND) -P CMakeFiles/boolean-serial-json-dynamic-large-precision.dir/cmake_clean.cmake
